...
See [ADVISORIES.md](ADVISORIES.md) (`ADV-10`, `ADV-11`) for the specific integrator-facing gaps this feature's own construction surfaced, and the [main README](../../README.md#ignition-lock--human-in-the-loop-for-destructive-moves) for the runtime-facing walkthrough.
